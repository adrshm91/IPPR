...
# feature_subset_pixels = [143, 48, 46, 47, 49, 142, 50, 51, 45, 44, 43, 42, 37, 648]

# feature_subset_pixels = [48, 46, 47, 49, 142, 50, 51, 45, 44, 43, 42, 37, 648]

feature_subset_pixels = [47,215,214,202,216,217,218,219,220,213,212,211,206,204,205,207,210,208,209,221,222,223,237,235,236,238,233,239,240,234,232,224,227,225,226,228,231,229,230,203,201,646,174,173, 648]
...
def create_arff_file(ped_data, nonped_data):
    ...
    file_access.write('@ATTRIBUTE Klasse       {0,1}\n')
...
def plot_graph(threshold,accuracy):
    ...
    plt.savefig(path_to_arf + 'fig1_greyscale.jpg')
    plt.show()
    ...
    plt.savefig(path_to_arf + 'fig2_greyscale.jpg')
    plt.show()
    ...
    plt.savefig(path_to_arf + 'fig3_greyscale.jpg')
    plt.show()
...
def main():
    ...
    #
    # create_csv_file(data_set, "data_set_greyscale")

    data_set = genfromtxt('/Users/adarshmallandur/Desktop/DaimlerBenchmark/data_set_greyscale.csv', delimiter=',')
